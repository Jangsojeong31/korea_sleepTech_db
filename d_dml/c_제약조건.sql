...
/*
	4. Check 제약 조건
		: 입력되는 데이터를 점검하는 기능
        - 테이블의 열에 대해 특정 조건을 설정, 조건을 만족하지 않을 경우 입력을 막음
*/
...
-- 	(0, '양현석', '1234'),
--     (2, '양현석', null),
--     # 오류: column phone에 null 값 불가
--     (3, '성재원', '1234');

/*
	6. default 제약 조건
		: 테이블의 열에 값이 명시적으로 제공되지 않은 경우 사용되는 기본값
...
values 
	(1, '노트북', 3),
	(2, '스마트폰', null),
    # null 값 입력 시 null 값이 지정됨: 기본값 설정 안됨
	(3, '노트북', 2);
